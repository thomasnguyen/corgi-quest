...
3. THE System SHALL display current Physical and Mental point progress in the top resource bar in the format "💪 X/60 | 🧠 Y/45"
...
1. THE System SHALL display the current Streak value with a fire emoji (🔥) in the top resource bar
...
2. THE System SHALL display "TODAY" label followed by Physical points progress (💪 X/60)
3. THE System SHALL display Mental points progress (🧠 Y/45)
4. THE System SHALL display the current Streak with fire emoji (🔥 Z)
